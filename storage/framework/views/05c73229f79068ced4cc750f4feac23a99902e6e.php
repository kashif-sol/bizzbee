                ...
                <div
                    ...
                    <input type="hidden" name="shop_id" value="<?php echo e(Auth::user()->id); ?>" id="shop_id">
                            <div class="form-inline"> <Label
                                    class="col-md-3 justify-content-left">Identity:</Label><input
                                    class="form-control form-control-sm col-md-9" type="text" name="strIdentity"
                                    placeholder="" value="<?php echo  $identity; ?>"> </div>
                            <div class="form-inline"> <label
                                    class="col-md-3 justify-content-left">Authentication:</label><input
                            ...
                            <div class="form-inline"> <label class="col-md-3 justify-content-left">Source:</label><input
                                    ...
                                    placeholder="" value="<?php echo  $sonce; ?>"></div>
                            <div class="row">
...
<?php /**PATH /var/www/shopify/shopify/resources/views/welcome.blade.php ENDPATH**/ ?>