...
return [
    ...
    */
    ...
    'api_key' => env('SHOPIFY_API_KEY', 'aa0bf9698fa87b81eab8d9f4c743aab6'),
    ...
    */
    ...
    'api_secret' => env('SHOPIFY_API_SECRET', 'bafc2515ee8dd424b61b247524ef4655'),
    ...
    'webhooks' => [
        ...
        [
         ...
         [
            ...
            'address' => env('APP_URL').'/webhook/product-create'
        ],
        [
